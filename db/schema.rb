...
ActiveRecord::Schema.define(version: 20_200_809_064_341) do
  ...
  create_table 'line_link_nonces', force: :cascade do |t|
    t.bigint 'user_id', null: false
    t.string 'nonce', default: '', null: false
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index ['user_id'], name: 'index_line_link_nonces_on_user_id'
  end
  ...
  create_table 'users', force: :cascade do |t|
    ...
    t.string 'line_user_id', default: ''
    t.index ['email'], name: 'index_users_on_email', unique: true
    t.index ['reset_password_token'], name: 'index_users_on_reset_password_token', unique: true
  end

  add_foreign_key 'articles', 'users'
  add_foreign_key 'line_link_nonces', 'users'
